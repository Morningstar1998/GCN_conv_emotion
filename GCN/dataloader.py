...
class DailyDialogueDataset2(Dataset):
    ...
    def __init__(self, split, path):
        ...
        self.ActLabels, self.EmotionLabels, self.trainId, self.testId, self.validId = pickle.load(open('/content/gdrive/MyDrive/GCN/conv-emotion/DialogueRNN/dailydialog/daily_dialogue.pkl', 'rb'))
